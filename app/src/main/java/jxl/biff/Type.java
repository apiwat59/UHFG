...
public final class Type {
    ...
    public static final Type TABID = new Type(TypedValues.AttributesType.TYPE_EASING);
    ...
    public static final Type XF = new Type(EnumG.BaseMid_SetResidenceTime);
    ...
    public static final Type SORT = new Type(SyslogAppender.LOG_LOCAL2);
    ...
    public static final Type UNKNOWN = new Type(SupportMenu.USER_MASK);
    ...
    private Type(int v) {
        this.value = v;
        Type[] typeArr = types;
        Type[] newTypes = new Type[typeArr.length + 1];
        System.arraycopy(typeArr, 0, newTypes, 0, typeArr.length);
