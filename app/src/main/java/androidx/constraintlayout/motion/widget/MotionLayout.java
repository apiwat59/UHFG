...
public class MotionLayout extends ConstraintLayout implements NestedScrollingParent3 {
    ...
    void setState(TransitionState newState) {
        ...
        int i = AnonymousClass5.$SwitchMap$androidx$constraintlayout$motion$widget$MotionLayout$TransitionState[oldState.ordinal()];
        if (i == 1 || i == 2) {
    ...
    private static class MyTracker implements MotionTracker {
        ...
        private static MyTracker f3me = new MyTracker();
        ...
        public static MyTracker obtain() {
            f3me.tracker = VelocityTracker.obtain();
            return f3me;
        }
