...
public class MotionPaths implements Comparable<MotionPaths> {
    ...
    void setView(float position, MotionWidget view, int[] toUse, double[] data, double[] slope, double[] cycle) {
        ...
        if (motion != null) {
            ...
            v_width = v_width3;
            v_height = v_height2;
            double sin2 = Math.sin(v_y4);
            Double.isNaN(d10);
            Double.isNaN(d9);
            double d11 = d9 + (d10 * sin2);
            double d12 = radius;
            double cos2 = Math.cos(v_y4);
            Double.isNaN(d12);
            double d13 = dangle;
            Double.isNaN(d13);
            float dpos_x = (float) (d11 + (d12 * cos2 * d13));
            double d14 = dry;
            double d15 = dradius;
            double cos3 = Math.cos(v_y4);
            Double.isNaN(d15);
            Double.isNaN(d14);
            double d16 = d14 - (d15 * cos3);
            double d17 = radius;
            double sin3 = Math.sin(v_y4);
            Double.isNaN(d17);
            double d18 = d17 * sin3;
            double d19 = dangle;
            Double.isNaN(d19);
    ...
    void getRect(int[] toUse, double[] data, float[] path, int offset) {
        ...
        if (rotation != 0.0f) {
            float v_x3 = rotation;
            float sin2 = (float) Math.sin(Math.toRadians(v_x3));
            float cos2 = (float) Math.cos(Math.toRadians(v_x3));
            float f = cx;
            float f2 = cy;
            float f3 = x1;
            float f4 = y1;
