...
public class VerticalWidgetRun extends WidgetRun {
    ...
    public void update(Dependency dependency) {
        ...
        if (this.dimension.readyToSolve && !this.dimension.resolved && this.dimensionBehavior == ConstraintWidget.DimensionBehaviour.MATCH_CONSTRAINT) {
            ...
            if (i2 != 2) {
                if (i2 == 3 && this.widget.horizontalRun.dimension.resolved) {
                    int size = 0;
                    int ratioSide = this.widget.getDimensionRatioSide();
                    if (ratioSide == -1) {
                        size = (int) ((this.widget.horizontalRun.dimension.value / this.widget.getDimensionRatio()) + 0.5f);
                    } else if (ratioSide == 0) {
                        size = (int) ((this.widget.horizontalRun.dimension.value * this.widget.getDimensionRatio()) + 0.5f);
                    } else if (ratioSide == 1) {
                        size = (int) ((this.widget.horizontalRun.dimension.value / this.widget.getDimensionRatio()) + 0.5f);
                ...
                if (parent != null && parent.verticalRun.dimension.resolved) {
                    ...
                    int size2 = (int) ((targetDimensionValue * percent) + 0.5f);
        ...
        if (!this.dimension.resolved && this.dimensionBehavior == ConstraintWidget.DimensionBehaviour.MATCH_CONSTRAINT) {
            ...
            if (i != 2) {
                if (i == 3 && !this.widget.isInVerticalChain() && this.widget.mMatchConstraintDefaultWidth != 3) {
                    DependencyNode targetDimension = this.widget.horizontalRun.dimension;
                ...
                if (parent3 != null) {
                    DependencyNode targetDimension2 = parent3.verticalRun.dimension;
