...
public final class FlowLiveDataConversions {
    ...
    public static final <T> LiveData<T> asLiveData(Flow<? extends T> asLiveData, CoroutineContext context, long timeoutInMs) {
        Intrinsics.checkParameterIsNotNull(asLiveData, "$this$asLiveData");
        Intrinsics.checkParameterIsNotNull(context, "context");
        return CoroutineLiveDataKt.liveData(context, timeoutInMs, new FlowLiveDataConversions$asLiveData$1(asLiveData, null));
    }
