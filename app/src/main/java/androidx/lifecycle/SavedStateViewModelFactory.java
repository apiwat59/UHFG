...
public final class SavedStateViewModelFactory extends ViewModelProvider.KeyedFactory {
    ...
    public <T extends ViewModel> T create(String str, Class<T> cls) {
        ...
        try {
            ?? r3 = isAssignableFrom ? (ViewModel) findMatchingConstructor.newInstance(this.mApplication, create.getHandle()) : (ViewModel) findMatchingConstructor.newInstance(create.getHandle());
