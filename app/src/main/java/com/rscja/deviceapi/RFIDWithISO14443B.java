...
public class RFIDWithISO14443B extends b {
    private static RFIDWithISO14443B a = null;
    ...
    public String sendCommand(String cmd) {
        ...
        if (ISO14443B_cpu_command == null || ISO14443B_cpu_command[0] != 0 || ISO14443B_cpu_command[1] == 0) {
            ...
            sb.append(ISO14443B_cpu_command == null ? Configurator.NULL : Character.valueOf(ISO14443B_cpu_command[0]));
            Log.e("RFIDWithISO14443B", sb.toString());
            return null;
        }
        char c = ISO14443B_cpu_command[1];
    ...
    public String reset() {
        ...
        if (ISO14443B_cpu_reset == null || ISO14443B_cpu_reset[0] != 0 || ISO14443B_cpu_reset[1] == 0) {
            ...
            sb.append(ISO14443B_cpu_reset == null ? Configurator.NULL : Character.valueOf(ISO14443B_cpu_reset[0]));
            Log.e("RFIDWithISO14443B", sb.toString());
            return null;
        }
        char c = ISO14443B_cpu_reset[1];
        char[] cArr = new char[c];
        for (int i = 0; i < c; i++) {
