...
public class FragmentNavigator extends Navigator<Destination> {
    ...
    public NavDestination navigate(Destination destination, Bundle args, NavOptions navOptions, Navigator.Extras navigatorExtras) {
        ...
        LogUtil.e("mFragmentManager.getFragments().size() = " + this.mFragmentManager.getFragments().size());
        if (this.mFragmentManager.getFragments().size() > 0) {
            Fragment lastFragment = this.mFragmentManager.getFragments().get(this.mFragmentManager.getFragments().size() - 1);
