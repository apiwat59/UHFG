...
public class MsgBaseDestroyGJb extends Message {
    ...
    public MsgBaseDestroyGJb(byte[] data) {
        this();
        if (data == null) {
            return;
        }
    ...
    public void ackUnpack() {
        Hashtable<Byte, String> dicErrorMsg = new Hashtable<Byte, String>() { // from class: com.gg.reader.api.protocol.gx.MsgBaseDestroyGJb.1
            {
                put((byte) 0, "Success.");
