...
public class MsgBaseWriteGJb extends Message {
    ...
    public MsgBaseWriteGJb(byte[] data) {
        this();
        if (data == null) {
            return;
        }
    ...
    public void ackUnpack() {
        Hashtable<Byte, String> dicErrorMsg = new Hashtable<Byte, String>() { // from class: com.gg.reader.api.protocol.gx.MsgBaseWriteGJb.1
            {
                put((byte) 0, "Success.");
