...
public class MsgTestCarrierWave extends Message {
    ...
    public MsgTestCarrierWave(byte[] data) {
        this();
        if (data == null) {
            return;
        }
    ...
    public void ackUnpack() {
        HashMap<Byte, String> dicErrorMsg = new HashMap<Byte, String>() { // from class: com.gg.reader.api.protocol.gx.MsgTestCarrierWave.1
            {
                put((byte) 0, "Success.");
