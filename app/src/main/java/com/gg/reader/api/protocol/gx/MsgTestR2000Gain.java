...
public class MsgTestR2000Gain extends Message {
    ...
    public MsgTestR2000Gain(byte[] data) {
        this();
        if (data == null) {
            return;
        }
        try {
            ...
            buffer.position(0);
            this.gain = buffer.getIntUnsigned(16);
        } catch (Exception e) {
        }
    }
    ...
    public void ackUnpack() {
        HashMap<Byte, String> dicErrorMsg = new HashMap<Byte, String>() { // from class: com.gg.reader.api.protocol.gx.MsgTestR2000Gain.1
            {
                put((byte) 0, "Success.");
                put((byte) 1, "Failure.");
            }
