...
public class MsgUpgradeBaseband extends Message {
    ...
    public MsgUpgradeBaseband(byte[] data) {
        this();
        if (data == null) {
            return;
        }
    ...
    public void ackUnpack() {
        Hashtable<Byte, String> dicErrorMsg = new Hashtable<Byte, String>() { // from class: com.gg.reader.api.protocol.gx.MsgUpgradeBaseband.1
            {
                put((byte) 0, "Success.");
                put((byte) 1, "Fail.");
            }
