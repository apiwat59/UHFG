...
public abstract class ExecutorCoroutineDispatcherBase extends ExecutorCoroutineDispatcher implements Delay {
    ...
    public void mo1009scheduleResumeAfterDelay(long timeMillis, CancellableContinuation<? super Unit> continuation) {
        ...
        if (this.removesFutureOnCancellation) {
            future = scheduleBlock(new ResumeUndispatchedRunnable(this, continuation), timeMillis, TimeUnit.MILLISECONDS);
        } else {
            future = null;
        }
        if (future != null) {
            ...
            DefaultExecutor.INSTANCE.mo1009scheduleResumeAfterDelay(timeMillis, continuation);
        }
    }
