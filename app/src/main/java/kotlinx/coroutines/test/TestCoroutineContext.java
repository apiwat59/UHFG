...
public final class TestCoroutineContext implements CoroutineContext {
        ...
        while (true) {
            ...
            synchronized (this_$iv) {
                ...
                if (first$iv != null) {
                    ...
                    timedRunnable = (it.time > targetTime ? 1 : (it.time == targetTime ? 0 : -1)) <= 0 ? this_$iv.removeAtImpl(0) : null;
                }
            }
    ...
    private final class Dispatcher extends EventLoop implements Delay {
        ...
        public void mo1008dispatch(CoroutineContext context, Runnable block) {
            Intrinsics.checkParameterIsNotNull(context, "context");
        ...
        public void mo1009scheduleResumeAfterDelay(long timeMillis, final CancellableContinuation<? super Unit> continuation) {
            ...
            TestCoroutineContext.this.postDelayed(new Runnable() { // from class: kotlinx.coroutines.test.TestCoroutineContext$Dispatcher$scheduleResumeAfterDelay$$inlined$Runnable$1
                ...
                public final void run() {
                    CancellableContinuation $this$with = continuation;
                    $this$with.resumeUndispatched(TestCoroutineContext.Dispatcher.this, Unit.INSTANCE);
                }
            }, timeMillis);
        }
