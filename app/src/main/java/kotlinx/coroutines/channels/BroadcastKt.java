...
public final class BroadcastKt {
    ...
    public static final <E> BroadcastChannel<E> broadcast(ReceiveChannel<? extends E> broadcast, int capacity, CoroutineStart start) {
        ...
        return broadcast(GlobalScope.INSTANCE, Dispatchers.getUnconfined(), capacity, start, ChannelsKt.consumes(broadcast), new BroadcastKt$broadcast$1(broadcast, null));
    }
