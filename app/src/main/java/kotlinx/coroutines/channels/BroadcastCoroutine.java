...
class BroadcastCoroutine<E> extends AbstractCoroutine<Unit> implements ProducerScope<E>, BroadcastChannel<E> {
    ...
    public BroadcastCoroutine(CoroutineContext parentContext, BroadcastChannel<E> _channel, boolean active) {
    ...
    public boolean cancel(Throwable cause) {
        this._channel.cancel(cause != null ? JobSupport.toCancellationException$default(this, cause, null, 1, null) : null);
