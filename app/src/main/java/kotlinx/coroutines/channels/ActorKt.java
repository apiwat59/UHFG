...
public final class ActorKt {
    public static final <E> SendChannel<E> actor(CoroutineScope actor, CoroutineContext context, int capacity, CoroutineStart start, Function1<? super Throwable, Unit> function1, Function2<? super ActorScope<E>, ? super Continuation<? super Unit>, ? extends Object> block) {
        LazyActorCoroutine coroutine;
        Intrinsics.checkParameterIsNotNull(actor, "$this$actor");
        Intrinsics.checkParameterIsNotNull(context, "context");
        Intrinsics.checkParameterIsNotNull(start, "start");
        Intrinsics.checkParameterIsNotNull(block, "block");
        CoroutineContext newContext = CoroutineContextKt.newCoroutineContext(actor, context);
