...
public class ChannelCoroutine<E> extends AbstractCoroutine<Unit> implements Channel<E> {
    ...
    public ChannelCoroutine(CoroutineContext parentContext, Channel<E> _channel, boolean active) {
    ...
    public boolean cancel(Throwable cause) {
        ...
        if (cause == null || (jobCancellationException = JobSupport.toCancellationException$default(this, cause, null, 1, null)) == null) {
            jobCancellationException = new JobCancellationException(DebugStringsKt.getClassSimpleName(this) + " was cancelled", null, this);
        }
        CancellationException exception = jobCancellationException;
