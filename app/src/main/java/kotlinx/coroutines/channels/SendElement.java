...
public final class SendElement extends Send {
    ...
    public SendElement(Object pollResult, CancellableContinuation<? super Unit> cont) {
    ...
    public void resumeSendClosed(Closed<?> closed) {
        ...
        cancellableContinuation.resumeWith(Result.m16constructorimpl(ResultKt.createFailure(sendException)));
    }
