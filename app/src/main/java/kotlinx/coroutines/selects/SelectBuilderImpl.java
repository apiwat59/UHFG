...
public final class SelectBuilderImpl<R> extends LockFreeLinkedListHead implements SelectBuilder<R>, SelectInstance<R>, Continuation<R>, CoroutineStackFrame {
            ...
            if (result$iv == obj) {
                ...
                if (atomicReferenceFieldUpdater.compareAndSet(this, coroutine_suspended, obj3)) {
                    if (Result.m22isFailureimpl(result)) {
                        ...
                        Throwable exception$iv = Result.m19exceptionOrNullimpl(result);
                        if (exception$iv == null) {
                            Intrinsics.throwNpe();
                        }
                        Result.Companion companion = Result.INSTANCE;
                        $this$resumeWithStackTrace$iv.resumeWith(Result.m16constructorimpl(ResultKt.createFailure(StackTraceRecoveryKt.recoverStackTrace(exception$iv, $this$resumeWithStackTrace$iv))));
                        return;
                    }
    ...
    private final void initCancellability() {
        ...
        CompletionHandlerBase $this$asHandler$iv = new SelectOnCancelling(this, parent);
    ...
    public final void handleBuilderException(Throwable e) {
        ...
        if (trySelect(null)) {
            Result.Companion companion = Result.INSTANCE;
            resumeWith(Result.m16constructorimpl(ResultKt.createFailure(e)));
    ...
    private final class AtomicSelectOp extends AtomicOp<Object> {
        ...
        public AtomicSelectOp(SelectBuilderImpl $outer, AtomicDesc desc) {
            Intrinsics.checkParameterIsNotNull(desc, "desc");
            this.this$0 = $outer;
            this.desc = desc;
        }
        ...
        public Object prepare(Object affected) {
            Object it;
            return (affected != null || (it = prepareIfNotSelected()) == null) ? this.desc.prepare(this) : it;
        }
        ...
        private final void completeSelect(Object failure) {
            ...
            SelectBuilderImpl update = selectSuccess ? null : this.this$0;
            if (SelectBuilderImpl._state$FU.compareAndSet(this.this$0, this, update) && selectSuccess) {
    ...
    public void onTimeout(long timeMillis, final Function1<? super Continuation<? super R>, ? extends Object> block) {
        ...
        if (timeMillis <= 0) {
            ...
            disposeOnSelect(DelayKt.getDelay(getContext()).invokeOnTimeout(timeMillis, action));
        }
    }
