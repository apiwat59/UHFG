...
public final class DebugStringsKt {
    ...
    public static final String toDebugString(Continuation<?> toDebugString) {
        ...
        try {
            ...
            m16constructorimpl = Result.m16constructorimpl(toDebugString + '@' + getHexAddress(toDebugString));
        } catch (Throwable th) {
        ...
        if (Result.m19exceptionOrNullimpl(m16constructorimpl) != null) {
            m16constructorimpl = toDebugString.getClass().getName() + '@' + getHexAddress(toDebugString);
        }
