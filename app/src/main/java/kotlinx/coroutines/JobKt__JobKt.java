...
public final /* synthetic */ class JobKt__JobKt {
    ...
    public static final /* synthetic */ Job m991Job(Job parent) {
        return JobKt.Job(parent);
    }

    /* renamed from: Job$default, reason: collision with other method in class */
    public static /* synthetic */ Job m992Job$default(Job job, int i, Object obj) {
        if ((i & 1) != 0) {
            job = (Job) null;
        }
        return m991Job(job);
    ...
    public static final DisposableHandle disposeOnCompletion(Job disposeOnCompletion, DisposableHandle handle) {
        ...
        CompletionHandlerBase $this$asHandler$iv = new DisposeOnCompletion(disposeOnCompletion, handle);
        return disposeOnCompletion.invokeOnCompletion($this$asHandler$iv);
    }
    ...
    public static final Object cancelAndJoin(Job $this$cancelAndJoin, Continuation<? super Unit> continuation) {
        ...
        return $this$cancelAndJoin.join(continuation);
    }
    ...
    public static final void cancelChildren(Job cancelChildren, CancellationException cause) {
        Intrinsics.checkParameterIsNotNull(cancelChildren, "$this$cancelChildren");
        Sequence $this$forEach$iv = cancelChildren.getChildren();
    ...
    @Deprecated(level = DeprecationLevel.HIDDEN, message = "Since 1.2.0, binary compatibility with versions <= 1.1.x")
    public static final /* synthetic */ void cancelChildren(Job cancelChildren, Throwable cause) {
        Intrinsics.checkParameterIsNotNull(cancelChildren, "$this$cancelChildren");
        Sequence $this$forEach$iv = cancelChildren.getChildren();
        for (Object element$iv : $this$forEach$iv) {
            Job it = (Job) element$iv;
    ...
    public static final void cancel(CoroutineContext cancel, CancellationException cause) {
    ...
    public static final void cancel(Job cancel, String message, Throwable cause) {
        Intrinsics.checkParameterIsNotNull(cancel, "$this$cancel");
        Intrinsics.checkParameterIsNotNull(message, "message");
        cancel.cancel(ExceptionsKt.CancellationException(message, cause));
    }
    ...
    @Deprecated(level = DeprecationLevel.HIDDEN, message = "Since 1.2.0, binary compatibility with versions <= 1.1.x")
    public static final /* synthetic */ boolean cancel(CoroutineContext cancel, Throwable cause) {
        Intrinsics.checkParameterIsNotNull(cancel, "$this$cancel");
    ...
    public static final void cancelChildren(CoroutineContext cancelChildren, CancellationException cause) {
    ...
    @Deprecated(level = DeprecationLevel.HIDDEN, message = "Since 1.2.0, binary compatibility with versions <= 1.1.x")
    public static final /* synthetic */ void cancelChildren(CoroutineContext cancelChildren, Throwable cause) {
        Sequence $this$forEach$iv;
        Intrinsics.checkParameterIsNotNull(cancelChildren, "$this$cancelChildren");
        Job job = (Job) cancelChildren.get(Job.INSTANCE);
        if (job == null || ($this$forEach$iv = job.getChildren()) == null) {
