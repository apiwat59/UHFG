...
public final class FlowKt__TransformKt$mapNotNull$$inlined$unsafeTransform$1<R> implements Flow<R> {
    ...
    public static final class AnonymousClass2<T> implements FlowCollector<T> {
        ...
        public Object emit(Object value, Continuation $completion) {
            ...
            Object transformed = this.this$0.$transform$inlined$1.invoke(value, $completion);
            if (transformed == null) {
                return Unit.INSTANCE;
            }
            return flowCollector.emit(transformed, $completion);
        }
        ...
        public Object emit$$forInline(Object value, Continuation continuation) {
            ...
            InlineMarker.mark(5);
            FlowCollector flowCollector = this.$this_unsafeFlow$inlined;
            Object transformed = this.this$0.$transform$inlined$1.invoke(value, continuation);
            if (transformed == null) {
                return Unit.INSTANCE;
            }
            InlineMarker.mark(0);
            Object emit = flowCollector.emit(transformed, continuation);
            InlineMarker.mark(2);
            InlineMarker.mark(1);
            return emit;
        }
    ...
    public Object collect$$forInline(FlowCollector collector, Continuation continuation) {
        ...
        InlineMarker.mark(5);
        Flow $this$collect$iv = this.$this_unsafeTransform$inlined;
        AnonymousClass2 anonymousClass2 = new AnonymousClass2(collector, this);
        InlineMarker.mark(0);
        $this$collect$iv.collect(anonymousClass2, continuation);
        InlineMarker.mark(2);
        InlineMarker.mark(1);
        return Unit.INSTANCE;
    }
