...
public final class FlowKt__MigrationKt$switchMap$$inlined$flatMapLatest$1<R, T> extends SuspendLambda implements Function3<FlowCollector<? super R>, T, Continuation<? super Unit>, Object> {
    ...
    public final Object invokeSuspend(Object $result) {
        ...
        if (i == 0) {
            ...
            $this$transformLatest = this.p$;
            it = this.p$0;
            Function2 function2 = this.$transform;
            this.L$0 = $this$transformLatest;
            this.L$1 = it;
            this.L$2 = $this$transformLatest;
            this.label = 1;
            invoke = function2.invoke(it, this);
            if (invoke == coroutine_suspended) {
                return coroutine_suspended;
            }
            $this$emitAll$iv = $this$transformLatest;
        } else {
            if (i != 1) {
                if (i != 2) {
            ...
            it = this.L$1;
            FlowCollector $this$transformLatest2 = (FlowCollector) this.L$0;
            ResultKt.throwOnFailure($result);
            $this$emitAll$iv = flowCollector;
            $this$transformLatest = $this$transformLatest2;
            invoke = $result;
        }
        Flow flow$iv = (Flow) invoke;
        this.L$0 = $this$transformLatest;
        this.L$1 = it;
