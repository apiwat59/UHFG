...
final class ChannelFlowBuilder<T> extends ChannelFlow<T> {
    ...
    public ChannelFlowBuilder(Function2<? super ProducerScope<? super T>, ? super Continuation<? super Unit>, ? extends Object> block, CoroutineContext context, int capacity) {
