...
public final class FlowKt__LimitKt$drop$$inlined$unsafeFlow$1<T> implements Flow<T> {
    ...
    public Object collect(FlowCollector collector, Continuation $completion) {
        ...
        skipped.element = 0;
        Flow $this$collect$iv = this.$this_drop$inlined;
        return $this$collect$iv.collect(new FlowKt__LimitKt$drop$$inlined$unsafeFlow$1$lambda$1(collector, skipped, this), $completion);
    }
}
