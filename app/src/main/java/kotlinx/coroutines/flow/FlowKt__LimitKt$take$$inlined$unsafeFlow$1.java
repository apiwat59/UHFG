    ...
    */
    public java.lang.Object collect(kotlinx.coroutines.flow.FlowCollector r12, kotlin.coroutines.Continuation r13) {
        ...
        L19:
            ...
            kotlin.ResultKt.throwOnFailure(r1)     // Catch: kotlinx.coroutines.flow.internal.AbortFlowException -> L4d
            goto L8b
        L4d:
            r4 = move-exception
            goto L91
        ...
        L57:
            ...
            r8.element = r5
            r5 = r8
            kotlinx.coroutines.flow.Flow r8 = r11.$this_take$inlined     // Catch: kotlinx.coroutines.flow.internal.AbortFlowException -> L8c
            r9 = 0
            kotlinx.coroutines.flow.FlowKt__LimitKt$take$$inlined$unsafeFlow$1$lambda$1 r10 = new kotlinx.coroutines.flow.FlowKt__LimitKt$take$$inlined$unsafeFlow$1$lambda$1     // Catch: kotlinx.coroutines.flow.internal.AbortFlowException -> L8c
            r10.<init>(r6, r5, r11)     // Catch: kotlinx.coroutines.flow.internal.AbortFlowException -> L8c
            kotlinx.coroutines.flow.FlowCollector r10 = (kotlinx.coroutines.flow.FlowCollector) r10     // Catch: kotlinx.coroutines.flow.internal.AbortFlowException -> L8c
            r0.L$0 = r11     // Catch: kotlinx.coroutines.flow.internal.AbortFlowException -> L8c
            r0.L$1 = r12     // Catch: kotlinx.coroutines.flow.internal.AbortFlowException -> L8c
            r0.L$2 = r3     // Catch: kotlinx.coroutines.flow.internal.AbortFlowException -> L8c
            r0.L$3 = r6     // Catch: kotlinx.coroutines.flow.internal.AbortFlowException -> L8c
            r0.L$4 = r5     // Catch: kotlinx.coroutines.flow.internal.AbortFlowException -> L8c
            r0.L$5 = r8     // Catch: kotlinx.coroutines.flow.internal.AbortFlowException -> L8c
            r0.label = r4     // Catch: kotlinx.coroutines.flow.internal.AbortFlowException -> L8c
            java.lang.Object r4 = r8.collect(r10, r0)     // Catch: kotlinx.coroutines.flow.internal.AbortFlowException -> L8c
            if (r4 != r2) goto L87
            return r2
        L87:
            r8 = r11
