...
public final class FlowKt__ZipKt$combine$$inlined$unsafeFlow$4<R> implements Flow<R> {
    ...
    public Object collect(FlowCollector collector, Continuation $completion) {
        ...
        Intrinsics.needClassReification();
        return CombineKt.combineInternal(collector, flowArr, new FlowKt__ZipKt$combine$$inlined$unsafeFlow$4$lambda$1(this), new FlowKt__ZipKt$combine$$inlined$unsafeFlow$4$lambda$2(null, this), $completion);
    }
    ...
    public Object collect$$forInline(FlowCollector collector, Continuation continuation) {
        ...
        InlineMarker.mark(0);
        CombineKt.combineInternal(collector, flowArr, flowKt__ZipKt$combine$$inlined$unsafeFlow$4$lambda$1, flowKt__ZipKt$combine$$inlined$unsafeFlow$4$lambda$2, continuation);
        InlineMarker.mark(2);
        InlineMarker.mark(1);
