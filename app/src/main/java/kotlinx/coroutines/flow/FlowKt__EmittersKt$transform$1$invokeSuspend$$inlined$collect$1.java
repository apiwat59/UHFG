...
public final class FlowKt__EmittersKt$transform$1$invokeSuspend$$inlined$collect$1<T> implements FlowCollector<T> {
    ...
    public Object emit(Object value, Continuation $completion) {
        return this.this$0.$transform.invoke(this.$this_flow$inlined, value, $completion);
    }
    ...
    public Object emit$$forInline(Object value, Continuation continuation) {
        ...
        InlineMarker.mark(5);
        return this.this$0.$transform.invoke(this.$this_flow$inlined, value, continuation);
    }
}
