...
public final class FlowKt__TransformKt$filterNot$$inlined$unsafeTransform$1<T> implements Flow<T> {
    ...
    public static final class AnonymousClass2 implements FlowCollector<T> {
        ...
        public Object emit(Object value, Continuation $completion) {
            ...
            if (!((Boolean) this.this$0.$predicate$inlined.invoke(value, $completion)).booleanValue()) {
                return $receiver.emit(value, $completion);
            }
        ...
        public Object emit$$forInline(Object value, Continuation continuation) {
            ...
            InlineMarker.mark(5);
            FlowCollector $receiver = this.$this_unsafeFlow$inlined;
            if (!((Boolean) this.this$0.$predicate$inlined.invoke(value, continuation)).booleanValue()) {
                InlineMarker.mark(0);
                Object emit = $receiver.emit(value, continuation);
                InlineMarker.mark(2);
                InlineMarker.mark(1);
                return emit;
            }
