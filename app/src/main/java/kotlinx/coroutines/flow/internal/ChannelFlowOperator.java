...
public abstract class ChannelFlowOperator<S, T> extends ChannelFlow<T> {
    ...
    public ChannelFlowOperator(Flow<? extends S> flow, CoroutineContext context, int capacity) {
    ...
    final /* synthetic */ Object collectWithContextUndispatched(FlowCollector<? super T> flowCollector, CoroutineContext newContext, Continuation<? super Unit> continuation) {
        ...
        return ChannelFlowKt.withContextUndispatched$default(newContext, null, new ChannelFlowOperator$collectWithContextUndispatched$2(this, null), originalContextCollector, continuation, 2, null);
    }
    ...
    static /* synthetic */ Object collectTo$suspendImpl(ChannelFlowOperator channelFlowOperator, ProducerScope scope, Continuation $completion) {
        return channelFlowOperator.flowCollect(new SendingCollector(scope), $completion);
    }
    ...
    static /* synthetic */ Object collect$suspendImpl(ChannelFlowOperator channelFlowOperator, FlowCollector collector, Continuation $completion) {
        if (channelFlowOperator.capacity == -3) {
            ...
            if (Intrinsics.areEqual((ContinuationInterceptor) newContext.get(ContinuationInterceptor.INSTANCE), (ContinuationInterceptor) collectContext.get(ContinuationInterceptor.INSTANCE))) {
