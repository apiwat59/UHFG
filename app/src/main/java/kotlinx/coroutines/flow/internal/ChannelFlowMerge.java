...
public final class ChannelFlowMerge<T> extends ChannelFlow<T> {
    ...
    public ChannelFlowMerge(Flow<? extends Flow<? extends T>> flow, int concurrency, CoroutineContext context, int capacity) {
    ...
    protected Object collectTo(ProducerScope<? super T> producerScope, Continuation<? super Unit> continuation) {
        ...
        return $this$collect$iv.collect(new ChannelFlowMerge$collectTo$$inlined$collect$1(job, semaphore, producerScope, collector), continuation);
    }
