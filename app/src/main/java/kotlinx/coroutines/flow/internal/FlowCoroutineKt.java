...
public final class FlowCoroutineKt {
    ...
    public static final <T> ReceiveChannel<T> flowProduce(CoroutineScope flowProduce, CoroutineContext context, int capacity, Function2<? super ProducerScope<? super T>, ? super Continuation<? super Unit>, ? extends Object> block) {
        Intrinsics.checkParameterIsNotNull(flowProduce, "$this$flowProduce");
        Intrinsics.checkParameterIsNotNull(context, "context");
        Intrinsics.checkParameterIsNotNull(block, "block");
        Channel channel = ChannelKt.Channel(capacity);
        CoroutineContext newContext = CoroutineContextKt.newCoroutineContext(flowProduce, context);
        FlowProduceCoroutine coroutine = new FlowProduceCoroutine(newContext, channel);
