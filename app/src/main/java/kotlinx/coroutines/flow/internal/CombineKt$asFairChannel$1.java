...
@DebugMetadata(c = "kotlinx.coroutines.flow.internal.CombineKt$asFairChannel$1", f = "Combine.kt", i = {0, 0, 0}, l = {SyslogAppender.LOG_LOCAL2}, m = "invokeSuspend", n = {"$this$produce", "channel", "$this$collect$iv"}, s = {"L$0", "L$1", "L$2"})
        ...
        if (i == 0) {
            ...
            FlowCollector<Object> flowCollector = new FlowCollector<Object>() { // from class: kotlinx.coroutines.flow.internal.CombineKt$asFairChannel$1$invokeSuspend$$inlined$collect$1
                ...
                public Object emit(Object value, Continuation $completion) {
                    return ChannelCoroutine.this.sendFair(value != null ? value : NullSurrogateKt.NULL, $completion);
                }
            };
