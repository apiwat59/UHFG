...
final class ChannelFlowTransformLatest$flowCollect$3 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    public final Object invokeSuspend(Object $result) {
        ...
        if (i == 0) {
            ...
            CoroutineScope $this$flowScope = this.p$;
            Ref.ObjectRef previousFlow = new Ref.ObjectRef();
            previousFlow.element = (Job) 0;
            Flow $this$collect$iv = this.this$0.flow;
            ChannelFlowTransformLatest$flowCollect$3$invokeSuspend$$inlined$collect$1 channelFlowTransformLatest$flowCollect$3$invokeSuspend$$inlined$collect$1 = new ChannelFlowTransformLatest$flowCollect$3$invokeSuspend$$inlined$collect$1(this, $this$flowScope, previousFlow);
            this.L$0 = $this$flowScope;
            this.L$1 = previousFlow;
            this.L$2 = $this$collect$iv;
            this.label = 1;
            if ($this$collect$iv.collect(channelFlowTransformLatest$flowCollect$3$invokeSuspend$$inlined$collect$1, this) == coroutine_suspended) {
