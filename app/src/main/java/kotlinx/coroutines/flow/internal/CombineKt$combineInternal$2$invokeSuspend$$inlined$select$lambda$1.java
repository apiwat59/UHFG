...
final class CombineKt$combineInternal$2$invokeSuspend$$inlined$select$lambda$1 extends SuspendLambda implements Function2<Object, Continuation<? super Unit>, Object> {
    ...
    public final Object invokeSuspend(Object $result) {
        ...
        if (i == 0) {
            ...
            this.$latestValues$inlined[this.$i] = value;
            Object[] $this$all$iv = this.$latestValues$inlined;
            int length = $this$all$iv.length;
            int i2 = 0;
            int i3 = 0;
            while (true) {
                if (i3 >= length) {
                ...
                Object element$iv = $this$all$iv[i3];
                if (!Boxing.boxBoolean(element$iv != null).booleanValue()) {
                    z = false;
                    break;
                }
                i3++;
