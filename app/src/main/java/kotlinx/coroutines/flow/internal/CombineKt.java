...
public final class CombineKt {
    ...
    public static final ReceiveChannel<Object> asFairChannel(CoroutineScope $this$asFairChannel, Flow<?> flow) {
        return ProduceKt.produce$default($this$asFairChannel, null, 0, new CombineKt$asFairChannel$1(flow, null), 3, null);
    }
    ...
    public static final ReceiveChannel<Object> asChannel(CoroutineScope $this$asChannel, Flow<?> flow) {
        return ProduceKt.produce$default($this$asChannel, null, 0, new CombineKt$asChannel$1(flow, null), 3, null);
    }
}
