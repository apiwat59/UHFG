...
public final class FlowKt__LimitKt$dropWhile$$inlined$unsafeFlow$1<T> implements Flow<T> {
    ...
    public Object collect(FlowCollector collector, Continuation $completion) {
        ...
        Flow $this$collect$iv = this.$this_dropWhile$inlined;
        return $this$collect$iv.collect(new FlowKt__LimitKt$dropWhile$$inlined$unsafeFlow$1$lambda$1(collector, matched, this), $completion);
    }
}
