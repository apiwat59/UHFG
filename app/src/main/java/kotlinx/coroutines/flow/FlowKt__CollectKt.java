...
final /* synthetic */ class FlowKt__CollectKt {
    ...
    private static final Object collect$$forInline(Flow $this$collect, Function2 action, Continuation continuation) {
        FlowKt__CollectKt$collect$3 flowKt__CollectKt$collect$3 = new FlowKt__CollectKt$collect$3(action);
        InlineMarker.mark(0);
        Object collect = $this$collect.collect(flowKt__CollectKt$collect$3, continuation);
        InlineMarker.mark(2);
        InlineMarker.mark(1);
        return collect;
    }
    ...
    private static final Object collectIndexed$$forInline(Flow $this$collectIndexed, Function3 action, Continuation continuation) {
        FlowKt__CollectKt$collectIndexed$2 flowKt__CollectKt$collectIndexed$2 = new FlowKt__CollectKt$collectIndexed$2(action);
        InlineMarker.mark(0);
        Object collect = $this$collectIndexed.collect(flowKt__CollectKt$collectIndexed$2, continuation);
        InlineMarker.mark(2);
        InlineMarker.mark(1);
        return collect;
    }
    ...
    private static final Object emitAll$$forInline(FlowCollector $this$emitAll, Flow flow, Continuation continuation) {
        InlineMarker.mark(0);
        Object collect = flow.collect($this$emitAll, continuation);
        InlineMarker.mark(2);
        InlineMarker.mark(1);
        return collect;
    }
