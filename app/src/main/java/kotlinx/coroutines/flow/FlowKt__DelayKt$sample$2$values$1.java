...
final class FlowKt__DelayKt$sample$2$values$1 extends SuspendLambda implements Function2<ProducerScope<? super Object>, Continuation<? super Unit>, Object> {
    ...
    public final Object invokeSuspend(Object $result) {
        ...
        if (i == 0) {
            ...
            FlowKt__DelayKt$sample$2$values$1$invokeSuspend$$inlined$collect$1 flowKt__DelayKt$sample$2$values$1$invokeSuspend$$inlined$collect$1 = new FlowKt__DelayKt$sample$2$values$1$invokeSuspend$$inlined$collect$1($this$produce);
            this.L$0 = $this$produce;
            this.L$1 = $this$collect$iv;
            this.label = 1;
            if ($this$collect$iv.collect(flowKt__DelayKt$sample$2$values$1$invokeSuspend$$inlined$collect$1, this) == coroutine_suspended) {
