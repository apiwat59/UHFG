    ...
    */
    public java.lang.Object collect(kotlinx.coroutines.flow.FlowCollector r11, kotlin.coroutines.Continuation r12) {
        ...
        L19:
            ...
            kotlin.ResultKt.throwOnFailure(r1)     // Catch: kotlinx.coroutines.flow.internal.AbortFlowException -> L47
            goto L7a
        L47:
            r4 = move-exception
            goto L7f
        ...
        L51:
            ...
            r5 = r11
            r6 = 0
            kotlinx.coroutines.flow.Flow r7 = r10.$this_takeWhile$inlined     // Catch: kotlinx.coroutines.flow.internal.AbortFlowException -> L7b
            r8 = 0
            kotlinx.coroutines.flow.FlowKt__LimitKt$takeWhile$$inlined$unsafeFlow$1$lambda$1 r9 = new kotlinx.coroutines.flow.FlowKt__LimitKt$takeWhile$$inlined$unsafeFlow$1$lambda$1     // Catch: kotlinx.coroutines.flow.internal.AbortFlowException -> L7b
            r9.<init>(r5, r10)     // Catch: kotlinx.coroutines.flow.internal.AbortFlowException -> L7b
            kotlinx.coroutines.flow.FlowCollector r9 = (kotlinx.coroutines.flow.FlowCollector) r9     // Catch: kotlinx.coroutines.flow.internal.AbortFlowException -> L7b
            r0.L$0 = r10     // Catch: kotlinx.coroutines.flow.internal.AbortFlowException -> L7b
            r0.L$1 = r11     // Catch: kotlinx.coroutines.flow.internal.AbortFlowException -> L7b
            r0.L$2 = r3     // Catch: kotlinx.coroutines.flow.internal.AbortFlowException -> L7b
            r0.L$3 = r5     // Catch: kotlinx.coroutines.flow.internal.AbortFlowException -> L7b
            r0.L$4 = r7     // Catch: kotlinx.coroutines.flow.internal.AbortFlowException -> L7b
            r0.label = r4     // Catch: kotlinx.coroutines.flow.internal.AbortFlowException -> L7b
            java.lang.Object r4 = r7.collect(r9, r0)     // Catch: kotlinx.coroutines.flow.internal.AbortFlowException -> L7b
            if (r4 != r2) goto L77
            return r2
        L77:
            r7 = r10
