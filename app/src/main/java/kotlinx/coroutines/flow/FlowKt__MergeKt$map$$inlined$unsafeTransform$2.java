...
public final class FlowKt__MergeKt$map$$inlined$unsafeTransform$2<R> implements Flow<R> {
    ...
    public static final class AnonymousClass2<T> implements FlowCollector<T> {
        ...
        public Object emit(Object value, Continuation $completion) {
            return this.$this_unsafeFlow$inlined.emit(this.this$0.$transform$inlined$1.invoke(value, $completion), $completion);
        }
        ...
        public Object emit$$forInline(Object value, Continuation continuation) {
            ...
            Object invoke = this.this$0.$transform$inlined$1.invoke(value, continuation);
            InlineMarker.mark(0);
