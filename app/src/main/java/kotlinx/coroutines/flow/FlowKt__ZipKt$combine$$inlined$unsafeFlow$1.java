...
public final class FlowKt__ZipKt$combine$$inlined$unsafeFlow$1<R> implements Flow<R> {
    ...
    public Object collect(FlowCollector collector, Continuation $completion) {
        return CombineKt.combineTransformInternal(collector, this.$this_combine$inlined, this.$flow$inlined, new FlowKt__ZipKt$combine$$inlined$unsafeFlow$1$lambda$1(null, this), $completion);
    }
}
