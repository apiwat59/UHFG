...
public final class FlowKt__TransformKt$unsafeTransform$$inlined$unsafeFlow$4<R> implements Flow<R> {
    ...
    public Object collect(FlowCollector collector, Continuation $completion) {
        ...
        return $this$collect$iv.collect(new FlowKt__TransformKt$unsafeTransform$$inlined$unsafeFlow$4$lambda$1(collector, this), $completion);
    }
    ...
    public Object collect$$forInline(FlowCollector collector, Continuation continuation) {
        ...
        InlineMarker.mark(5);
        Flow $this$collect$iv = this.$this_unsafeTransform$inlined;
        FlowKt__TransformKt$unsafeTransform$$inlined$unsafeFlow$4$lambda$1 flowKt__TransformKt$unsafeTransform$$inlined$unsafeFlow$4$lambda$1 = new FlowKt__TransformKt$unsafeTransform$$inlined$unsafeFlow$4$lambda$1(collector, this);
        InlineMarker.mark(0);
        $this$collect$iv.collect(flowKt__TransformKt$unsafeTransform$$inlined$unsafeFlow$4$lambda$1, continuation);
        InlineMarker.mark(2);
        InlineMarker.mark(1);
