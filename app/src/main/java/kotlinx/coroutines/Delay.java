...
public interface Delay {
    ...
    void mo1009scheduleResumeAfterDelay(long timeMillis, CancellableContinuation<? super Unit> continuation);
    ...
    public static final class DefaultImpls {
        public static Object delay(Delay $this, long time, Continuation<? super Unit> continuation) {
            ...
            $this.mo1009scheduleResumeAfterDelay(time, it);
        ...
        public static DisposableHandle invokeOnTimeout(Delay $this, long timeMillis, Runnable block) {
            Intrinsics.checkParameterIsNotNull(block, "block");
            return DefaultExecutorKt.getDefaultDelay().invokeOnTimeout(timeMillis, block);
        }
    }
}
