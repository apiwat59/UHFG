...
public final class SupervisorKt {
    ...
    public static final /* synthetic */ Job m993SupervisorJob(Job parent) {
        return SupervisorJob(parent);
    }

    /* renamed from: SupervisorJob$default, reason: collision with other method in class */
    public static /* synthetic */ Job m994SupervisorJob$default(Job job, int i, Object obj) {
        if ((i & 1) != 0) {
            job = (Job) null;
        }
        return m993SupervisorJob(job);
    }
