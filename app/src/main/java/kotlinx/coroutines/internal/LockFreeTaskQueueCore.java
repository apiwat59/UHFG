...
public final class LockFreeTaskQueueCore<E> {
    ...
    public LockFreeTaskQueueCore(int capacity, boolean singleConsumer) {
        ...
        int i = capacity - 1;
        this.mask = i;
        this.array$internal = new AtomicReferenceArray(capacity);
        if (!(i <= 1073741823)) {
    ...
    */
    public final int addLast(E r28) {
        ...
        L4c:
            ...
            if (r0 != 0) goto L6d
            java.util.concurrent.atomic.AtomicReferenceArray r0 = r6.array$internal
            r13 = r2 & r3
    ...
    */
    public final java.lang.Object removeFirstOrNull() {
        ...
        L5:
            ...
            if (r4 == 0) goto L16
            kotlinx.coroutines.internal.Symbol r13 = kotlinx.coroutines.internal.LockFreeTaskQueueCore.REMOVE_FROZEN
            goto Lac
        L16:
            kotlinx.coroutines.internal.LockFreeTaskQueueCore$Companion r0 = kotlinx.coroutines.internal.LockFreeTaskQueueCore.INSTANCE
            r14 = r10
            ...
            r18 = r5
            r19 = 0
            int r0 = access$getMask$p(r6)
            r0 = r18 & r0
            int r1 = access$getMask$p(r6)
            r1 = r1 & r2
            if (r0 != r1) goto L43
            r13 = 0
            goto Lac
        L43:
            ...
            if (r3 != 0) goto L5b
            boolean r0 = access$getSingleConsumer$p(r6)
            if (r0 == 0) goto L58
            r13 = 0
            goto Lac
        L58:
            ...
            goto L99
        L5b:
            boolean r0 = r3 instanceof kotlinx.coroutines.internal.LockFreeTaskQueueCore.Placeholder
            if (r0 == 0) goto L61
            r13 = 0
            goto Lac
        L61:
            ...
            long r20 = r13.updateHead(r10, r1)
            r13 = r1
            r1 = r6
            r23 = r3
            r22 = r7
        ...
        L9d:
            ...
            kotlinx.coroutines.internal.LockFreeTaskQueueCore r0 = (kotlinx.coroutines.internal.LockFreeTaskQueueCore) r0
        La0:
            kotlinx.coroutines.internal.LockFreeTaskQueueCore r1 = access$removeSlowPath(r0, r7, r13)
            if (r1 == 0) goto Laa
            r0 = r1
            goto La0
        Laa:
    ...
    public final Object removeFirstOrNullIf(Function1<? super E, Boolean> predicate) {
        ...
        while (true) {
            ...
            Object element = this.array$internal.get(this.mask & head$iv);
            if (element == null) {
                ...
                if ((element instanceof Placeholder) || !predicate2.invoke(element).booleanValue()) {
                    return null;
                }
                int newHead = (head$iv + 1) & MAX_CAPACITY_MASK;
                $i$f$removeFirstOrNullIf = $i$f$removeFirstOrNullIf2;
                $this$loop$iv = $this$loop$iv2;
                if (!_state$FU$internal.compareAndSet(this, state, INSTANCE.updateHead(state, newHead))) {
                    if (this.singleConsumer) {
                    ...
                    this.array$internal.set(this.mask & head$iv, null);
                    return element;
                }
            }
    ...
    private final LockFreeTaskQueueCore<E> allocateNextCopy(long state) {
        ...
        while (true) {
            ...
            if ((index & i) != (tail$iv & i)) {
                ...
                next._state$internal = INSTANCE.wo(state, FROZEN_MASK);
                return next;
            }
        }
    }
