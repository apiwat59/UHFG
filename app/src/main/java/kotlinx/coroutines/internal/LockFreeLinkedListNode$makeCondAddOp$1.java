...
public final class LockFreeLinkedListNode$makeCondAddOp$1 extends LockFreeLinkedListNode.CondAddOp {
    ...
    public LockFreeLinkedListNode$makeCondAddOp$1(Function0 $captured_local_variable$0, LockFreeLinkedListNode $captured_local_variable$1, LockFreeLinkedListNode $super_call_param$2) {
        super($super_call_param$2);
        this.$condition = $captured_local_variable$0;
