...
public final class ConcurrentKt {
    ...
    public static final <E> Set<E> identitySet(int expectedSize) {
        Set<E> newSetFromMap = Collections.newSetFromMap(new IdentityHashMap(expectedSize));
    ...
    public static final boolean removeFutureOnCancel(Executor executor) {
        ...
        try {
            ScheduledExecutorService executor2 = (ScheduledExecutorService) (!(executor instanceof ScheduledExecutorService) ? null : executor);
