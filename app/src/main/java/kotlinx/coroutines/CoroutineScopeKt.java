...
public final class CoroutineScopeKt {
    ...
    public static final void cancel(CoroutineScope cancel, CancellationException cause) {
    ...
    public static final void cancel(CoroutineScope cancel, String message, Throwable cause) {
        Intrinsics.checkParameterIsNotNull(cancel, "$this$cancel");
