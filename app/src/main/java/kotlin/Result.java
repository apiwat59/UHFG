...
public final class Result<T> implements Serializable {
    ...
    public boolean equals(Object other) {
        return m17equalsimpl(this.value, other);
    }
    ...
    public static Object m16constructorimpl(Object value) {
        return value;
    }
    ...
    private static final T m20getOrNullimpl(Object obj) {
        if (m22isFailureimpl(obj)) {
            return null;
        }
        return obj;
    }
    ...
    public static final Throwable m19exceptionOrNullimpl(Object $this) {
    ...
    public static final class Companion {
        ...
        private final <T> Object success(T value) {
            return Result.m16constructorimpl(value);
        }

        private final <T> Object failure(Throwable exception) {
            return Result.m16constructorimpl(ResultKt.createFailure(exception));
        }
    }
