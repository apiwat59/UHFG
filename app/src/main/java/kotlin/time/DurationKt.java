...
public final class DurationKt {
    ...
    public static final double toDuration(double $this$toDuration, TimeUnit unit) {
        Intrinsics.checkParameterIsNotNull(unit, "unit");
        return Duration.m938constructorimpl(DurationUnitKt.convertDurationUnit($this$toDuration, unit, TimeUnit.NANOSECONDS));
    }
    ...
    private static final double m983timesmvk6XK0(int $this$times, double duration) {
        return Duration.m965timesimpl(duration, $this$times);
    }

    /* renamed from: times-kIfJnKk, reason: not valid java name */
    private static final double m982timeskIfJnKk(double $this$times, double duration) {
        return Duration.m964timesimpl(duration, $this$times);
    }
}
