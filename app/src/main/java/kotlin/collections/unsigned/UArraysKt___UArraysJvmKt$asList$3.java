...
public final class UArraysKt___UArraysJvmKt$asList$3 extends AbstractList<UByte> implements RandomAccess {
    ...
    public final /* bridge */ boolean contains(Object obj) {
        if (obj instanceof UByte) {
            return m389contains7apg3OU(((UByte) obj).getData());
        }
        return false;
    }
    ...
    public final /* bridge */ int indexOf(Object obj) {
        if (obj instanceof UByte) {
            return m390indexOf7apg3OU(((UByte) obj).getData());
        }
        return -1;
    }
    ...
    public final /* bridge */ int lastIndexOf(Object obj) {
        if (obj instanceof UByte) {
            return m391lastIndexOf7apg3OU(((UByte) obj).getData());
        }
        return -1;
    }
    ...
    public int get_size() {
        return UByteArray.m84getSizeimpl(this.$this_asList);
    }

    @Override // kotlin.collections.AbstractCollection, java.util.Collection
    public boolean isEmpty() {
        return UByteArray.m86isEmptyimpl(this.$this_asList);
    }

    /* renamed from: contains-7apg3OU, reason: not valid java name */
    public boolean m389contains7apg3OU(byte element) {
        return UByteArray.m79contains7apg3OU(this.$this_asList, element);
    }

    @Override // kotlin.collections.AbstractList, java.util.List
    public UByte get(int index) {
        return UByte.m28boximpl(UByteArray.m83getimpl(this.$this_asList, index));
    }

    /* renamed from: indexOf-7apg3OU, reason: not valid java name */
    public int m390indexOf7apg3OU(byte element) {
