...
class UCollectionsKt___UCollectionsKt {
    public static final byte[] toUByteArray(Collection<UByte> toUByteArray) {
        ...
        byte[] result = UByteArray.m77constructorimpl(toUByteArray.size());
        int index = 0;
        Iterator<UByte> it = toUByteArray.iterator();
        while (it.hasNext()) {
            byte element = it.next().getData();
            UByteArray.m88setVurrAj0(result, index, element);
            index++;
        }
        return result;
    }
    ...
    public static final int[] toUIntArray(Collection<UInt> toUIntArray) {
        ...
        int[] result = UIntArray.m146constructorimpl(toUIntArray.size());
        int index = 0;
        Iterator<UInt> it = toUIntArray.iterator();
        while (it.hasNext()) {
            int element = it.next().getData();
            UIntArray.m157setVXSXFK8(result, index, element);
            index++;
        }
        return result;
    }
    ...
    public static final long[] toULongArray(Collection<ULong> toULongArray) {
        ...
        long[] result = ULongArray.m215constructorimpl(toULongArray.size());
        int index = 0;
        Iterator<ULong> it = toULongArray.iterator();
        while (it.hasNext()) {
            long element = it.next().getData();
            ULongArray.m226setk8EXiF4(result, index, element);
            index++;
        }
        return result;
    }
    ...
    public static final short[] toUShortArray(Collection<UShort> toUShortArray) {
        ...
        short[] result = UShortArray.m310constructorimpl(toUShortArray.size());
        int index = 0;
        Iterator<UShort> it = toUShortArray.iterator();
        while (it.hasNext()) {
            short element = it.next().getData();
            UShortArray.m321set01HTLdE(result, index, element);
            index++;
        }
        return result;
    }
    ...
    public static final int sumOfUInt(Iterable<UInt> sum) {
        ...
        while (it.hasNext()) {
            int element = it.next().getData();
            sum2 = UInt.m101constructorimpl(sum2 + element);
        }
        return sum2;
    }
    ...
    public static final long sumOfULong(Iterable<ULong> sum) {
        ...
        while (it.hasNext()) {
            long element = it.next().getData();
            sum2 = ULong.m170constructorimpl(sum2 + element);
        }
        return sum2;
    }
    ...
    public static final int sumOfUByte(Iterable<UByte> sum) {
        ...
        while (it.hasNext()) {
            byte element = it.next().getData();
            sum2 = UInt.m101constructorimpl(UInt.m101constructorimpl(element & 255) + sum2);
        }
        return sum2;
    }
    ...
    public static final int sumOfUShort(Iterable<UShort> sum) {
        ...
        while (it.hasNext()) {
            short element = it.next().getData();
            sum2 = UInt.m101constructorimpl(UInt.m101constructorimpl(65535 & element) + sum2);
        }
        return sum2;
    }
}
