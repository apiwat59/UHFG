...
public class ULongProgression implements Iterable<ULong>, KMappedMarker {
    ...
    private ULongProgression(long start, long endInclusive, long step) {
        ...
        this.first = start;
        this.last = UProgressionUtilKt.m877getProgressionLastElement7ftBX0g(start, endInclusive, step);
        this.step = step;
    }
    ...
    public int hashCode() {
        ...
        long j = this.first;
        int m170constructorimpl = ((int) ULong.m170constructorimpl(j ^ ULong.m170constructorimpl(j >>> 32))) * 31;
        long j2 = this.last;
        int m170constructorimpl2 = (m170constructorimpl + ((int) ULong.m170constructorimpl(j2 ^ ULong.m170constructorimpl(j2 >>> 32)))) * 31;
        long j3 = this.step;
        return ((int) (j3 ^ (j3 >>> 32))) + m170constructorimpl2;
    }
    ...
    public String toString() {
        ...
        if (this.step > 0) {
            ...
            sb.append(ULong.m207toStringimpl(this.first));
            sb.append("..");
            sb.append(ULong.m207toStringimpl(this.last));
            sb.append(" step ");
            j = this.step;
        } else {
            sb = new StringBuilder();
    ...
    public static final class Companion {
        ...
        public final ULongProgression m894fromClosedRange7ftBX0g(long rangeStart, long rangeEnd, long step) {
