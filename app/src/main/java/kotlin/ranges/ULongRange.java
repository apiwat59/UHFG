...
public final class ULongRange extends ULongProgression implements ClosedRange<ULong> {
    ...
    public /* bridge */ /* synthetic */ boolean contains(ULong uLong) {
        return m895containsVKZWuLQ(uLong.getData());
    }

    @Override // kotlin.ranges.ClosedRange
    public ULong getStart() {
        return ULong.m164boximpl(getFirst());
    }

    @Override // kotlin.ranges.ClosedRange
    public ULong getEndInclusive() {
        return ULong.m164boximpl(getLast());
    }

    /* renamed from: contains-VKZWuLQ, reason: not valid java name */
    public boolean m895containsVKZWuLQ(long value) {
    ...
    public int hashCode() {
        ...
        return ((int) ULong.m170constructorimpl(getLast() ^ ULong.m170constructorimpl(getLast() >>> 32))) + (((int) ULong.m170constructorimpl(getFirst() ^ ULong.m170constructorimpl(getFirst() >>> 32))) * 31);
    }

    @Override // kotlin.ranges.ULongProgression
    public String toString() {
        return ULong.m207toStringimpl(getFirst()) + ".." + ULong.m207toStringimpl(getLast());
    }
