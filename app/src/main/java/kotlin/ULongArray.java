...
public final class ULongArray implements Collection<ULong>, KMappedMarker {
    ...
    public static final /* synthetic */ ULongArray m214boximpl(long[] v) {
    ...
    public static final boolean m220equalsimpl0(long[] p1, long[] p2) {
    ...
    public boolean m228addVKZWuLQ(long j) {
        throw new UnsupportedOperationException("Operation is not supported for read-only collection");
    }
    ...
    public boolean m229containsVKZWuLQ(long j) {
        return m217containsVKZWuLQ(this.storage, j);
    }

    @Override // java.util.Collection
    public boolean containsAll(Collection<? extends Object> collection) {
        return m218containsAllimpl(this.storage, collection);
    }

    @Override // java.util.Collection
    public boolean equals(Object other) {
        return m219equalsimpl(this.storage, other);
    }
    ...
    public final /* bridge */ boolean contains(Object obj) {
        if (obj instanceof ULong) {
            return m229containsVKZWuLQ(((ULong) obj).getData());
        }
        return false;
    }
    ...
    /* renamed from: constructor-impl, reason: not valid java name */
    public static long[] m215constructorimpl(int size) {
        return m216constructorimpl(new long[size]);
    }

    /* renamed from: get-impl, reason: not valid java name */
    public static final long m221getimpl(long[] $this, int index) {
        return ULong.m170constructorimpl($this[index]);
    }

    /* renamed from: set-k8EXiF4, reason: not valid java name */
    public static final void m226setk8EXiF4(long[] $this, int index, long value) {
        $this[index] = value;
    }

    /* renamed from: getSize-impl, reason: not valid java name */
    public static int m222getSizeimpl(long[] $this) {
        return $this.length;
    }

    /* renamed from: iterator-impl, reason: not valid java name */
    public static ULongIterator m225iteratorimpl(long[] $this) {
    ...
    private static final class Iterator extends ULongIterator {
        ...
        public long nextULong() {
            ...
            this.index = i + 1;
            return ULong.m170constructorimpl(jArr[i]);
        }
    }

    /* renamed from: contains-VKZWuLQ, reason: not valid java name */
    public static boolean m217containsVKZWuLQ(long[] $this, long element) {
        return ArraysKt.contains($this, element);
    }

    /* renamed from: containsAll-impl, reason: not valid java name */
    public static boolean m218containsAllimpl(long[] $this, Collection<ULong> elements) {
    ...
    public static boolean m224isEmptyimpl(long[] $this) {
