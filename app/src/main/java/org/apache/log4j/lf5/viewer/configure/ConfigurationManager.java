...
public class ConfigurationManager {
    ...
    protected void processCategories(Document doc) {
        ...
        ?? equalsIgnoreCase = getValue(nodeList.item(0).getAttributes(), NAME).equalsIgnoreCase(FIRST_CATEGORY_NAME);
        for (int i = nodeList.getLength() - 1; i >= equalsIgnoreCase; i--) {
            ...
            getValue(map, EXPANDED).equalsIgnoreCase("true");
    ...
    private void exportXMLElement(CategoryNode node, TreePath path, StringBuffer xml) {
        ...
        xml.append(NAME);
        xml.append("=\"");
        xml.append(node.getTitle());
        xml.append("\" ");
        xml.append(PATH);
        xml.append("=\"");
        xml.append(treePathToString(path));
        xml.append("\" ");
        xml.append(EXPANDED);
        xml.append("=\"");
        xml.append(tree.isExpanded(path));
        xml.append("\" ");
        xml.append(SELECTED);
        xml.append("=\"");
        xml.append(node.isSelected());
        xml.append("\"/>\r\n");
    }
    ...
    private void exportLogLevelColorXMLElement(String label, Color color, StringBuffer xml) {
        ...
        xml.append(RED);
        xml.append("=\"");
        xml.append(color.getRed());
        xml.append("\" ");
        xml.append(GREEN);
        xml.append("=\"");
        xml.append(color.getGreen());
        xml.append("\" ");
        xml.append(BLUE);
        xml.append("=\"");
        xml.append(color.getBlue());
        xml.append("\"/>\r\n");
    }
