...
public class LogBrokerMonitor {
    ...
    protected void initComponents() {
        ...
        LogTable logTable = new LogTable(detailTA);
        ...
        this._logTableScrollPane = jScrollPane;
        if (this._trackTableScrollPane) {
            jScrollPane.getVerticalScrollBar().addAdjustmentListener(new TrackingAdjustmentListener());
        }
    ...
    protected LogRecordFilter createLogRecordFilter() {
        LogRecordFilter result = new LogRecordFilter() { // from class: org.apache.log4j.lf5.viewer.LogBrokerMonitor.3
    ...
    protected LogRecordFilter createNDCLogRecordFilter(String text) {
        this._NDCTextFilter = text;
        LogRecordFilter result = new LogRecordFilter() { // from class: org.apache.log4j.lf5.viewer.LogBrokerMonitor.4
            @Override // org.apache.log4j.lf5.LogRecordFilter
            public boolean passes(LogRecord record) {
                String NDC = record.getNDC();
                CategoryPath path = new CategoryPath(record.getCategory());
                return (NDC == null || LogBrokerMonitor.this._NDCTextFilter == null || NDC.toLowerCase().indexOf(LogBrokerMonitor.this._NDCTextFilter.toLowerCase()) == -1 || !LogBrokerMonitor.this.getMenuItem(record.getLevel()).isSelected() || !LogBrokerMonitor.this._categoryExplorerTree.getExplorerModel().isCategoryPathActive(path)) ? false : true;
            }
        };
        return result;
    }
    ...
    protected void addTableModelProperties() {
        ...
        addDisplayedProperty(new Object() { // from class: org.apache.log4j.lf5.viewer.LogBrokerMonitor.5
            public String toString() {
                return LogBrokerMonitor.this.getRecordsDisplayedMessage();
            }
        });
        addDisplayedProperty(new Object() { // from class: org.apache.log4j.lf5.viewer.LogBrokerMonitor.6
            public String toString() {
                StringBuffer stringBuffer = new StringBuffer();
                stringBuffer.append("Maximum number of displayed LogRecords: ");
                stringBuffer.append(model._maxNumberOfLogRecords);
    ...
    protected void makeLogTableListenToCategoryExplorer() {
        ActionListener listener = new ActionListener() { // from class: org.apache.log4j.lf5.viewer.LogBrokerMonitor.7
    ...
    protected JMenuItem createAllLogLevelsMenuItem() {
        ...
        result.addActionListener(new ActionListener() { // from class: org.apache.log4j.lf5.viewer.LogBrokerMonitor.8
            public void actionPerformed(ActionEvent e) {
    ...
    protected JMenuItem createNoLogLevelsMenuItem() {
        ...
        result.addActionListener(new ActionListener() { // from class: org.apache.log4j.lf5.viewer.LogBrokerMonitor.9
            public void actionPerformed(ActionEvent e) {
    ...
    protected JMenuItem createResetLogLevelColorMenuItem() {
        ...
        result.addActionListener(new ActionListener() { // from class: org.apache.log4j.lf5.viewer.LogBrokerMonitor.10
            public void actionPerformed(ActionEvent e) {
    ...
    protected JMenuItem createSubMenuItem(final LogLevel level) {
        ...
        result.addActionListener(new ActionListener() { // from class: org.apache.log4j.lf5.viewer.LogBrokerMonitor.11
            public void actionPerformed(ActionEvent e) {
    ...
    protected JCheckBoxMenuItem createMenuItem(LogLevel level) {
        ...
        result.setMnemonic(level.toString().charAt(0));
        result.addActionListener(new ActionListener() { // from class: org.apache.log4j.lf5.viewer.LogBrokerMonitor.12
            public void actionPerformed(ActionEvent e) {
                LogBrokerMonitor.this._table.getFilteredLogTableModel().refresh();
                LogBrokerMonitor.this.updateStatusLabel();
            }
    ...
    protected JCheckBoxMenuItem createLogTableColumnMenuItem(LogTableColumn column) {
        ...
        result.addActionListener(new ActionListener() { // from class: org.apache.log4j.lf5.viewer.LogBrokerMonitor.13
            public void actionPerformed(ActionEvent e) {
    ...
    protected JMenuItem createAllLogTableColumnsMenuItem() {
        ...
        result.setMnemonic('s');
        result.addActionListener(new ActionListener() { // from class: org.apache.log4j.lf5.viewer.LogBrokerMonitor.14
            public void actionPerformed(ActionEvent e) {
    ...
    protected JMenuItem createNoLogTableColumnsMenuItem() {
        ...
        result.setMnemonic('h');
        result.addActionListener(new ActionListener() { // from class: org.apache.log4j.lf5.viewer.LogBrokerMonitor.15
            public void actionPerformed(ActionEvent e) {
    ...
    protected JMenuItem createOpenMI() {
        ...
        result.addActionListener(new ActionListener() { // from class: org.apache.log4j.lf5.viewer.LogBrokerMonitor.16
            public void actionPerformed(ActionEvent e) {
    ...
    protected JMenuItem createOpenURLMI() {
        ...
        result.addActionListener(new ActionListener() { // from class: org.apache.log4j.lf5.viewer.LogBrokerMonitor.17
            public void actionPerformed(ActionEvent e) {
    ...
    protected JMenuItem createCloseMI() {
        ...
        result.addActionListener(new ActionListener() { // from class: org.apache.log4j.lf5.viewer.LogBrokerMonitor.18
            public void actionPerformed(ActionEvent e) {
    ...
    protected void createMRUFileListMI(JMenu menu) {
        ...
        if (files != null) {
            ...
            for (int i = 0; i < files.length; i++) {
                ...
                JMenuItem result = new JMenuItem(stringBuffer.toString());
                result.setMnemonic(i + 1);
                result.addActionListener(new ActionListener() { // from class: org.apache.log4j.lf5.viewer.LogBrokerMonitor.19
                    public void actionPerformed(ActionEvent e) {
    ...
    protected JMenuItem createExitMI() {
        ...
        result.addActionListener(new ActionListener() { // from class: org.apache.log4j.lf5.viewer.LogBrokerMonitor.20
            public void actionPerformed(ActionEvent e) {
    ...
    protected JMenuItem createConfigureSave() {
        ...
        result.setMnemonic('s');
        result.addActionListener(new ActionListener() { // from class: org.apache.log4j.lf5.viewer.LogBrokerMonitor.21
            public void actionPerformed(ActionEvent e) {
    ...
    protected JMenuItem createConfigureReset() {
        ...
        result.setMnemonic('r');
        result.addActionListener(new ActionListener() { // from class: org.apache.log4j.lf5.viewer.LogBrokerMonitor.22
            public void actionPerformed(ActionEvent e) {
    ...
    protected JMenuItem createConfigureMaxRecords() {
        ...
        result.addActionListener(new ActionListener() { // from class: org.apache.log4j.lf5.viewer.LogBrokerMonitor.23
            public void actionPerformed(ActionEvent e) {
    ...
    protected JMenuItem createHelpProperties() {
        ...
        result.setMnemonic('l');
        result.addActionListener(new ActionListener() { // from class: org.apache.log4j.lf5.viewer.LogBrokerMonitor.24
            public void actionPerformed(ActionEvent e) {
    ...
    protected JMenuItem createEditFindNextMI() {
        ...
        editFindNextMI.addActionListener(new ActionListener() { // from class: org.apache.log4j.lf5.viewer.LogBrokerMonitor.25
            public void actionPerformed(ActionEvent e) {
    ...
    protected JMenuItem createEditFindMI() {
        ...
        editFindMI.addActionListener(new ActionListener() { // from class: org.apache.log4j.lf5.viewer.LogBrokerMonitor.26
            public void actionPerformed(ActionEvent e) {
    ...
    protected JMenuItem createEditSortNDCMI() {
        ...
        editSortNDCMI.addActionListener(new ActionListener() { // from class: org.apache.log4j.lf5.viewer.LogBrokerMonitor.27
            public void actionPerformed(ActionEvent e) {
    ...
    protected JMenuItem createEditRestoreAllNDCMI() {
        ...
        editRestoreAllNDCMI.addActionListener(new ActionListener() { // from class: org.apache.log4j.lf5.viewer.LogBrokerMonitor.28
            public void actionPerformed(ActionEvent e) {
    ...
    protected JToolBar createToolBar() {
        ...
        newButton.addActionListener(new ActionListener() { // from class: org.apache.log4j.lf5.viewer.LogBrokerMonitor.29
            public void actionPerformed(ActionEvent e) {
        ...
        fontCombo.addActionListener(new ActionListener() { // from class: org.apache.log4j.lf5.viewer.LogBrokerMonitor.30
            public void actionPerformed(ActionEvent e) {
        ...
        fontSizeCombo.addActionListener(new ActionListener() { // from class: org.apache.log4j.lf5.viewer.LogBrokerMonitor.31
            public void actionPerformed(ActionEvent e) {
                JComboBox box = (JComboBox) e.getSource();
    ...
    protected void setView(String viewString, LogTable table) {
        if (DETAILED_VIEW.equals(viewString)) {
            ...
            StringBuffer stringBuffer = new StringBuffer();
            stringBuffer.append(viewString);
    ...
    protected JComboBox createLogLevelCombo() {
        ...
        result.addActionListener(new ActionListener() { // from class: org.apache.log4j.lf5.viewer.LogBrokerMonitor.32
            public void actionPerformed(ActionEvent e) {
                JComboBox box = (JComboBox) e.getSource();
